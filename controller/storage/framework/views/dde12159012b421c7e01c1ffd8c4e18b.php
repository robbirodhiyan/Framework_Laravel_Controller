                ...
                <div class="p-5 bg-light rounded-3 border col-xl-6">
                    ...
                    <div class="row">
                        <div class="col-md-6 mb-3">
                            ...
                            <input class="form-control <?php if($errors->has('firstName')): ?> is-invalid <?php endif; ?>"
                        ...
                        <div class="col-md-6 mb-3">
                            <label for="lastName" class="form-label">Last
                                Name</label>
                            <input class="form-control <?php if($errors->has('lastName')): ?> is-invalid <?php endif; ?>"
                        ...
                        <div class="col-md-6 mb-3">
                            ...
                            <input class="form-control <?php if($errors->has('age')): ?> is-invalid <?php endif; ?>"
...
<?php /**PATH C:\xampp\htdocs\controller_laravel\resources\views/employee/create.blade.php ENDPATH**/ ?>